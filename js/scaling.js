const SCALE_START = {
    super: {
		...
		hex: E('1e1e1e1e1e102021'),
        massUpg: E('1e1e1e1e1e102021'),
		tickspeed: E('1e1e1e1e1e102021'),
		bh_condenser: E('1e1e1e1e1e102021'),
		gamma_ray: E('1e1e1e1e1e102021'),
		supernova: E('1e1e1e1e1e102021'),
		fTier: E('1e1e1e1e1e102021'),
		cosmic_str: E('1e1e1e1e1e102021'),
		prestige0: E('1e1e1e1e1e102021'),
		prestige1: E('1e1e1e1e1e102021'),
		prestige2: E('1e1e1e1e1e102021'),
		prestige3: E('1e1e1e1e1e102021'),
		prestige4: E('1e1e1e1e1e102021'),
		massUpg4: E('1e1e1e1e1e102021'),
		FSS: E('1e1e1e1e1e102021'),
		fvm: E('1e1e1e1e1e102021'),
		pe: E('1e1e1e1e1e102021'),
		inf_theorem: E('1e1e1e1e1e102021'),
		ascension0: E('1e1e1e1e1e102021'),
		ascension1: E('1e1e1e1e1e102021'),
		gal_prestige: E('1e1e1e1e1e102021'),
    },
	hyper: {
		rank: E('1e1e1e1e1e102021'),
		tier: E('1e1e1e1e1e102021'),
		tetr: E('1e1e1e1e1e102021'),
		pent: E('1e1e1e1e1e102021'),
		hex: E('1e1e1e1e1e102021'),
